...
<%response.setHeader("Cache-Control", "no-cache");
  ...
  <a href="updatestud.jsp">Student_record</a>
...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Enter Documents Record:-</h2><br>

<div class="container">
  <form action="docs_recordcon.jsp" method="post">
...
%>
    ...
    <label for="10TH__CERT">10th Certificate</label><br>
    <select  id="10TH__CERT" name="10TH__CERT" style="width:170px;">
      <option value="yes">Yes</option>
      <option value="no">NO</option>
    </select><br>
    <label for="12TH_CERT">12th Certificate</label><br>
     <select id="12TH_CERT" name="12TH_CERT" style="width:170px;">
      <option value="yes">Yes</option>
      <option value="no">NO</option>
    </select><br>
     <label for="TRANSFER_CERT">Transfer Certificate</label><br>
     <select id="TRANSFER_CERT" name="TRANSFER_CERT" style="width:170px;">
      <option value="yes">Yes</option>
      <option value="no">NO</option>
    </select><br>
      <label for="SCORE_CARD">Score Card</label><br>
     <select id="SCORE_CARD" name="SCORE_CARD" style="width:170px;">
      <option value="yes">Yes</option>
      <option value="no">NO</option>
    </select><br>
     
    <label for="GAP_CERT">Gap Certificate</label><br>
     <select id="GAP_CERT" name="GAP_CERT" style="width:170px;">
      <option value="yes">Yes</option>
      <option value="no">NO</option>
    </select>
