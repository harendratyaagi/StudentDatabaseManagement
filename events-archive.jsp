...
<html lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
     <title>MANIT : Events Archive</title>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
              <div class="footer_bootomRight">
                <p>Designed by soft.eng.jangra and Harendra Tyagi</a></p>
              </div>
            </div>
          </div>
        </div>
