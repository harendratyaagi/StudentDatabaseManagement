...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Examination Time Table:-</h2><br>

<div class="container">
  <form action="examcon.jsp">
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
       ...
       resultset =statement.executeQuery("select * from subject_y where YEAR='"+year+"'") ;
       
%>


    
        <select id="SUBJECT_CODE" name="SUBJECT_CODE" style="width:170px;"s>
        <%  while(resultset.next()){ %>
            <option  value=<%=resultset.getString(2) %>><%= resultset.getString(2)%> Sem <%= resultset.getString(1) %></option>
        <% } %>
        </select><br>

       <label for="exam_type">Exam Type</label><br>
    <select id="EXAM_TYPE" name="EXAM_TYPE" style="width:170px;">
      <option value="mini">Mini Test</option>
      <option value="mid">Mid Term</option>
      <option value="end">End Term</option>
     </select><br>
     <label for="EXAM_DATE">Exam Date</lable><br><br>
     <input type="Date" id="EXAM_DATE" name="EXAM_DATE"  placeholder="enter exam date..."><br><br>
       <label for="EXAM_TIME">Exam Time</lable><br><br>
     <input type="Time" id="EXAM_TIME" name="EXAM_TIME"  placeholder="enter exam time..."><br><br>
      <label for="ROOM_NO">Room No</lable><br><br>
     <input type="number" id="ROOM_NO" name="ROOM_NO"  placeholder="enter room no..."><br><br>
