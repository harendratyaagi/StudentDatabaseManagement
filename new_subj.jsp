...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Enter New Subjects:-</h2><br>

<div class="container">
  <form action="new_subjcon.jsp" method="post">

  
    <label for="SUBJECT_CODE">Subject Code</label><br>
     <input type="text" id="SUBJECT_CODE" name="SUBJECT_CODE" placeholder="enter subject code..."><br><br>
   
     <label for="SUB_NAME">Subject Name</label><br>
    <input type="text" id="SUB_NAME" name="SUB_NAME" placeholder="subj name..."><br><br>
    
      <label for="CREDITS">Credits</label><br>
     <input type="number" id="CREDITS" name="CREDITS" placeholder="enter subject credits..."><br><br>
