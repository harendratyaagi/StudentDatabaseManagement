...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Assign Project to Student:-</h2><br>

<div class="container">
  <form action="projassigncon.jsp" method="post">
...
%>
       ...
       <select id="PROJECT_ID" name="PROJECT_ID" style="width:170px;">
