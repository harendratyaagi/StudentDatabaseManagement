...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Enter Project Details:-</h2><br>

<div class="container">
  <form action="projectcon.jsp">

  
    <label for="PROJECT_NAME">Project Name</label><br>
     <input type="text" id="PROJECT_NAME" name="PROJECT_NAME" placeholder="enter project name...."><br><br>
    
     
      <label for="MENTOR_NAME">Mentor Name</label><br>
     <input type="text" id="MENTOR_NAME" name="MENTOR_NAME" placeholder="enter mentor name...."><br><br>
