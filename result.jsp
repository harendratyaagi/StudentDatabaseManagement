...
function closeNav() {
    ...
    <!--=========== END HEADER SECTION ================--> 
      ...
      <div class="footer_bottom">
        ...
        <!--start form body-->
<h2  style="font-style: oblique" align="center">Result of Students:-</h2><br>

<div class="container">
  <form action="resultcon.jsp" method="post">
...
%>
 ...
 resultset =statement.executeQuery("SELECT * FROM subject_y ") ;
 
 %>
 <label for="SUBJECT_CODE">Subject Code</label><br>
  
         <select id="SUBJECT_CODE" name="SUBJECT_CODE" style="width:170px;">
     ...
     <label for="GRADE_POINT">Grade Point</label><br>
    <input type="number" id="GRADE_POINT" name="GRADE_POINT" placeholder="grade obtained..."><br><br>
     <label for="GRADE">Grade</label><br>
      <select id="GRADE" name="GRADE" style="width:170px;">
