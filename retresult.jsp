          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="courseArchive_content">
              ...
              <div class="row">
                ...
                <h2  style="font-style: oblique" align="center">Your Result:-</h2><br>


<form action="" method="post">
<p align="center"><b>Enter Scholar Number:-</b>
<select name="sch"  style="margin-left:200px;border:2px solid:black; border-style:groove;width:180px">
...
<input type="submit" value="Get Result" onclick="this.form.submit();" style="margin-left:950px;">
<% 
try{
	 conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/studb","root","root");
	 st1=conn.createStatement();
	 rs1=st1.executeQuery("SELECT result.SUBJECT_CODE,subjects.SUB_NAME,result.GRADE_POINT,result.GRADE  FROM subjects INNER JOIN result ON subjects.SUBJECT_CODE = result.SUBJECT_CODE where scholar_no='"+request.getParameter("sch")+"'");
%>
