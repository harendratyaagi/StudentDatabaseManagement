          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="courseArchive_content">
              ...
              <div class="row">
                ...
                <h2  style="font-style: oblique" align="center">Your Subjects:-</h2><br>

<form action="" method="post">
<p align="center"><b>Select Semester:-</b>
<select name="sbj"  style="margin-left:200px;border:2px solid:black; border-style:groove;width:180px" onchange="this.form.submit();">
...
try{
	...
	ResultSet rs1=st1.executeQuery("SELECT subjects.SUBJECT_CODE,SUBJECTS.SUB_NAME, SUBJECTS.CREDITS FROM subjects INNER JOIN subject_y ON SUBJECTS.SUBJECT_CODE = SUBJECT_Y.SUBJECT_CODE where subject_y.semester='"+request.getParameter("sbj")+"'");
%>
<h3 align="center" style="color:red">Subjects </h3>
